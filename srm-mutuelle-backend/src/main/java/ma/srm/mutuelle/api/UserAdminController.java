...
public class UserAdminController {
	...
	@PostMapping
	public AppUserResponse create(@Valid @RequestBody CreateAppUserRequest body, Authentication authentication) {
		return userAdminService.create(body, AuthPrincipal.requireUser(authentication));
	}
